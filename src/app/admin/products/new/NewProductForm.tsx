    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white mb-1">Nuevo Producto</h1>
            <p className="text-gray-400">Agrega un nuevo producto al catálogo</p>
          </div>
        </div>
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            disabled={isPending}
            className="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <Save size={18} />
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Ej: Cuchillo Chef Profesional 8&quot;"
                  required
                />
              </div>
          ...
          <div className="bg-[#171718] border border-gray-800 rounded-xl p-6">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <label htmlFor="image-upload" className="aspect-square bg-[#0a0a0a] border-2 border-dashed border-gray-800 hover:border-orange-500 rounded-lg flex flex-col items-center justify-center gap-2 transition-colors cursor-pointer">
          ...
          <div className="bg-[#171718] border border-gray-800 rounded-xl p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-white">Variantes (Opcional)</h2>
              <button
                type="button"
                onClick={addVariant}
            ...
            {variants.length === 0 ? (
              <div className="text-center py-8 border-2 border-dashed border-gray-800 rounded-lg">
                <p className="text-gray-500 text-sm">
                  No hay variantes. Las variantes permiten ofrecer diferentes opciones del mismo producto.
                </p>
              </div>
            ) : (
              <div className="space-y-4">
                {variants.map((variant, index) => (
                  <div key={index} className="bg-[#0a0a0a] border border-gray-800 rounded-lg p-4">
                    <div className="flex items-start justify-between mb-4">
                      <h3 className="text-sm font-medium text-white">Variante #{index + 1}</h3>
                      <button
                        type="button"
